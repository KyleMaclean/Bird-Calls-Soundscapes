...
train_df = pd.read_csv("/cs/home/psykjm/input/birdclef-2021/train_metadata_new.csv")
target_columns = [
    "acafly",
    "acowoo",
    "aldfly",
...
class BirdClef2021Dataset(Dataset):
    def __init__(
        self,
        data_path: str = "/cs/home/psykjm/input/birdclef-2021/train_short_audio",
        pseudo_label_path: list = [
            "/cs/home/psykjm/input/birdclef-2021/pseudo_label_stage1_repvgg_b0",
            "/cs/home/psykjm/input/birdclef-2021/pseudo_label_stage1_resnet34",
        ],
        period: float = 15.0,
...
def main(args):
    ...
    for i in range(4):
        ...
        rootdir = f"../../logs/finetune_30s/{args.logdir}/fold{i}"
        weight_path = f"../../logs/stage2/{args.weightdir}/fold{i}/lightning_logs/version_0/checkpoints/best_loss.ckpt"
        model = BirdClef2021Model.load_from_checkpoint(weight_path, **vars(args))
