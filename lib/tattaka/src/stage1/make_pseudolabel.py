...
train_df = pd.read_csv("/cs/home/psykjm/input/birdclef-2021/train_metadata.csv")
train_soundscape_labels = pd.read_csv(
    "/cs/home/psykjm/input/birdclef-2021/train_soundscape_labels.csv"
)
valid_data = Path("/cs/home/psykjm/input/birdclef-2021/train_soundscapes/")
    ...
    for i, (trn_idx, val_idx) in enumerate(
        ...
        for j in trange(len(valid_df_fold)):
            ...
            filepath = os.path.join(
                "/cs/home/psykjm/input/birdclef-2021/train_short_audio", primary_label, filename
            )
            ...
            npy_filepath = os.path.join(
                f"/cs/home/psykjm/input/birdclef-2021/pseudo_label_stage1_{args.weight_stage1}",
                primary_label,
                filename.split(".")[0],
            )
            os.makedirs(
